...
"resin-settings": '''<svg viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
<rect x="28" y="30" width="184" height="22" rx="6" fill="currentColor"/>
<rect x="112" y="52" width="16" height="22" fill="currentColor"/>
<rect x="60" y="74" width="120" height="20" rx="4" fill="currentColor"/>
<rect x="60" y="100" width="120" height="20" rx="4" fill="currentColor" opacity=".72"/>
<rect x="60" y="126" width="120" height="20" rx="4" fill="currentColor" opacity=".46"/>
<path d="M120 160c14 18 22 30 22 40a22 22 0 0 1-44 0c0-10 8-22 22-40Z" fill="currentColor" opacity=".28"/>
</svg>''',
}
